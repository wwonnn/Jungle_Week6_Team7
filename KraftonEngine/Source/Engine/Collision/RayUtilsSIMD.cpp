	...
	float* OutTMinValues)
{
	...
	const __m256 T1X = _mm256_mul_ps(_mm256_sub_ps(MinXVec, Context.OriginX), Context.InvDirectionX);
	const __m256 T2X = _mm256_mul_ps(_mm256_sub_ps(MaxXVec, Context.OriginX), Context.InvDirectionX);
	const __m256 T1Y = _mm256_mul_ps(_mm256_sub_ps(MinYVec, Context.OriginY), Context.InvDirectionY);
	const __m256 T2Y = _mm256_mul_ps(_mm256_sub_ps(MaxYVec, Context.OriginY), Context.InvDirectionY);
	const __m256 T1Z = _mm256_mul_ps(_mm256_sub_ps(MinZVec, Context.OriginZ), Context.InvDirectionZ);
	const __m256 T2Z = _mm256_mul_ps(_mm256_sub_ps(MaxZVec, Context.OriginZ), Context.InvDirectionZ);
