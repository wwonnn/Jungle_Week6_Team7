...
- Include paths root at: `Source/Engine`, `Source`, `Source/Editor`, `ThirdParty`, `ThirdParty/ImGui`
...
- `CraftonEngine/Shaders/` — 8 HLSL files, `Common.hlsl` has shared constant buffers
- `CraftonEngine/ThirdParty/` — ImGui and SimpleJSON (vendored)
- `CraftonEngine/Asset/` — font atlas, particle textures, default scene
